...
export default function ClientOnboarding() {
  ...
  if (step === 2) return (
    <div style={page}>
      ...
      <div style={{ ...card, borderRadius: '0 0 16px 16px' }}>
        <div style={{ fontSize: 13, color: '#666', lineHeight: 1.6, marginBottom: 20 }}>This information was entered by your provider. Review it carefully. If anything is incorrect, contact your provider before continuing.</div>
  ...
  if (step === 3) return (
    <div style={page}>
      ...
      <div style={{ ...card, borderRadius: '0 0 16px 16px' }}>
        <div style={{ fontSize: 13, color: '#666', lineHeight: 1.6, marginBottom: 20 }}>Create a password to access your program portal.</div>
        ...
        <div style={{ fontSize: 12, color: '#888', marginBottom: 16, lineHeight: 1.6 }}>Do not share your password with anyone including your provider.</div>
        {error && <div style={{ color: '#cc0000', fontSize: 13, marginBottom: 12 }}>{error}</div>}
  ...
  if (step === 4) return (
    <div style={page}>
      ...
      <div style={{ ...card, borderRadius: '0 0 16px 16px' }}>
        <div style={{ fontSize: 13, color: '#666', lineHeight: 1.6, marginBottom: 16 }}>Read the following consent carefully. You must scroll through the full document before you can sign.</div>
        <div style={scrollBox} onScroll={e => { const el = e.target; if (el.scrollHeight - el.scrollTop <= el.clientHeight + 10) setGpsScrolled(true) }}>
          ...
          <strong>1. Location Monitoring</strong><br />I understand and agree that my geographic location will be verified through GPS technology each time I complete a required check-in. My device's location services must be enabled for check-ins to be recorded.<br /><br />
          ...
          <strong>6. Voluntary Acknowledgment</strong><br />By signing below, I confirm that I have read and understand this consent, that I am signing voluntarily, and that I have had the opportunity to ask my provider any questions prior to signing.
        </div>
    ...
    <div style={page}>
      ...
      <div style={{ ...card, borderRadius: '0 0 16px 16px' }}>
        ...
        <div style={scrollBox} onScroll={e => { const el = e.target; if (el.scrollHeight - el.scrollTop <= el.clientHeight + 10) setTermsScrolled(true) }}>
          ...
          <strong>4. Reporting Changes</strong><br />I agree to notify my program provider promptly if my phone number changes so that my account can be updated.<br /><br />
          <strong>5. Consequences of Non-Compliance</strong><br />I understand that missed check-ins, falsified locations, or failure to meet my program reporting requirements will be documented in the platform and may be reported to the court.<br /><br />
          <strong>6. Acknowledgment</strong><br />By signing below, I confirm that I have read and understand my program requirements and participation terms, and that I am entering into this acknowledgment voluntarily.
        </div>
