...
export default function ViolationReport() {
  ...
  function printReport(r) {
    ...
    win.document.write(`
      ...
      <div class="field"><span class="label">Client Name: </span><span class="val">${escapeHtml(r.clients?.name || '')}</span></div>
      <h2>Violation Details</h2>
      <div class="field"><span class="label">Violation Type: </span><span class="val">${escapeHtml(r.violation_type)}</span></div>
      <div class="warn">${escapeHtml(r.description)}</div>
      ...
      <div class="field"><span class="val">${escapeHtml(r.recommended_action)}</span></div>
      ${r.submitted_to ? `<h2>Submitted To</h2><div class="field"><span class="val">${escapeHtml(r.submitted_to)}</span></div>` : ''}
